...
<ResponseField name="output_param" type="str">
...
<ResponseField name="output_params" type="tuple[str, ...] | None">
  All output parameter names if multi-output node, else None
</ResponseField>

<ResponseField name="values" type="dict[str, Any] | None">
  All input values as `{name: value}` if multi-input interrupt, else None
</ResponseField>

<ResponseField name="response_key" type="str" getter>
...
<ResponseField name="response_keys" type="dict[str, str]" getter>
...
<ParamField path="raise" type="str">
  Stop immediately on first error and raise the exception (default)
</ParamField>

<ParamField path="continue" type="str">
...
<ResponseField name="PAUSED" type="str">
